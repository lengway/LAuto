...
"[project]/lib/services/ai-catalog-import.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function parseCatalogTextWithAi(rawInput, context) {
...
`;
    ...
    const rawErrors = Array.isArray(parsed.errors) ? parsed.errors.map((entry)=>normalizeIssue(entry)).filter((entry)=>Boolean(entry)) : [];
    const rowByLine = new Map(rows.map((row)=>[
            row.line,
            row
        ]));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/prisma.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ai$2d$catalog$2d$import$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/ai-catalog-import.ts [app-rsc] (ecmascript)");
...
const rowSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    line: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive(),
    ...
    oem: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    brand: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
    model: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
    ...
    price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].union([
...
function parsePrice(input) {
    ...
    const normalizedInput = String(input).replace(/\s+/g, "").replace(",", ".").trim();
...
function resolveOemNumber(input, importJobId, line) {
...
function rowsToCsv(rows) {
    ...
    const sheet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(exportRows);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["utils"].sheet_to_csv(sheet);
}
function parseCsvRows(csv) {
    const workbook = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["read"](csv, {
        type: "string"
    });
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["utils"].sheet_to_json(worksheet, {
        defval: "",
        raw: false
    });
}
async function importPartsFromAiAction(_prevState, formData) {
    ...
    let aiResult;
    try {
        const knownCars = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].car.findMany({
            include: {
                brand: {
                    select: {
                        name: true
        ...
        const knownModels = Array.from(new Set(knownCars.flatMap((car)=>{
            const fullName = [
                car.brand.name,
                car.model,
                car.generation
        ...
        aiResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ai$2d$catalog$2d$import$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseCatalogTextWithAi"])(parsedForm.data.rawInput, {
            knownModels
        });
    } catch (error) {
        return {
    ...
    try {
        ...
        for(let index = 0; index < parsedCsvRows.length; index += 1){
            ...
            try {
                ...
                const existingPart = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].part.findUnique({
                    where: {
                        oemNumber
                    },
                    select: {
                ...
                const part = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].part.upsert({
                    where: {
                        oemNumber
                    },
                    update: {
                ...
                const compatibility = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].partCompatibility.createMany({
                    data: [
                        {
                            partId: part.id,
                            carId: car.id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a98d916._.js.map