...
_s(CartProvider, "7Riyl54jyUoRmsGK6iJ/D24AGSo=");
_c = CartProvider;
function useCart() {
    _s1();
    ...
    if ($[0] !== "a1717a91ef359d380227b41778a62cb3fa45f40c838b34d340bea29544a44cad") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a1717a91ef359d380227b41778a62cb3fa45f40c838b34d340bea29544a44cad";
    }
...
"[project]/frontend/lib/config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/components/cart/cart-fab.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$cart$2f$cart$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/components/cart/cart-provider.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$cart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/cart.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/config.ts [app-client] (ecmascript)");
;
...
function CartFab() {
    ...
    if ($[0] !== "81ada400ab5816fa45ba975f54c37b4d11c9e991785e4c0fd58cd41296e6e8ba") {
        for(let $i = 0; $i < 29; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "81ada400ab5816fa45ba975f54c37b4d11c9e991785e4c0fd58cd41296e6e8ba";
    }
    const { items, totalItems, removeItem, setQuantity, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$cart$2f$cart$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    let t0;
    if ($[1] !== items) {
        const message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$cart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createWhatsAppOrderMessage"])(items);
        t0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildWhatsAppLink"])(message);
        $[1] = items;
        $[2] = t0;
    } else {
        t0 = $[2];
    }
    const whatsappHref = t0;
    const t1 = totalItems > 0 ? `(${totalItems})` : "";
    let t2;
    if ($[3] !== t1) {
    ...
    let t4;
    if ($[6] !== items || $[7] !== removeItem || $[8] !== setQuantity) {
        t4 = items.length ? items.map({
            "CartFab[items.map()]": (item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        item.compatibleCars.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    size: "sm",
                                    onClick: {
                                        "CartFab[items.map() > <Button>.onClick]": ()=>removeItem(item.partId)
                                    }["CartFab[items.map() > <Button>.onClick]"],
                                    children: "Удалить"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/components/cart/cart-fab.tsx",
                                    lineNumber: 55,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    variant: "outline",
                                    onClick: {
                                        "CartFab[items.map() > <Button>.onClick]": ()=>setQuantity(item.partId, item.quantity - 1)
                                    }["CartFab[items.map() > <Button>.onClick]"],
                                    children: "-"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/components/cart/cart-fab.tsx",
        ...
        }["CartFab[items.map()]"]) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t6 = !items.length;
    let t7;
    if ($[12] !== clearCart || $[13] !== t6) {
    ...
    const t8 = !items.length;
    let t9;
    if ($[15] !== whatsappHref) {
        t9 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: whatsappHref,
            target: "_blank",
            rel: "noreferrer",
...
_s(CartFab, "WJg9z0hug2D5E9xOzL99McBdNyI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$cart$2f$cart$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
_c = CartFab;
var _c;
__turbopack_context__.k.register(_c, "CartFab");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const AuroraBackground = (t0)=>{
    ...
    if ($[0] !== "8f12a2d344d9ae30b7b689ae42c63a2be9900c73d818f6fa7435a25f5c2f5922") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8f12a2d344d9ae30b7b689ae42c63a2be9900c73d818f6fa7435a25f5c2f5922";
    }
    let children;
    let className;
    ...
    if ($[17] !== contentClassName) {
        t9 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative z-10 flex min-h-screen flex-col", contentClassName);
        $[17] = contentClassName;
        $[18] = t9;
    } else {
        t9 = $[18];
    ...
    let t11;
    if ($[22] !== props || $[23] !== t10 || $[24] !== t2 || $[25] !== t8) {
...
//# sourceMappingURL=frontend_697aca67._.js.map